...
$ venv/bin/python projects/scripts/src/scripts/channeling_map_with_window.py [minimum energy: int] [maximum energy: int] [detector: str] [folder: str] 

Example:
$ venv/bin/python projects/scripts/src/scripts/channeling_map_with_window.py 10 900 d01 /tmp/ACQ/5_data/RBS22_084/AE200856_D07/ 
